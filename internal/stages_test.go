...
func normalizeTesterOutput(testerOutput []byte) []byte {
	replacements := map[string][]*regexp.Regexp{
		...
		"grep_output_with_dir_prefix_2": {regexp.MustCompile(`.{5}\[tester::#YX6\].{5}✓ Found line 'dir/.*`)},
		"grep_output_with_dir_prefix_3": {regexp.MustCompile(`.{5}\[tester::#YX6\].{5}⨯ Line not found: "dir/.*`)},
	}
